...
// Mechwild Ascension v0.7 true custom mech mod integration
...
PlayerEvents.loggedIn(event => {
  if (Platform.isLoaded('mechwildmechs')) {
    event.player.tell('§bMechwild Mechs v0.7 detected. §fUse a Mech Deployment Core to enter the cockpit, repair with Mech Salvage, and trigger frame abilities while piloting.')
  }
})
