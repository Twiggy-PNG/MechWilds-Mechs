...
public class MechwildMechs {
    ...
    public static final RegistryObject<EntityType<RaptorMechEntity>> RAPTOR_MECH = ENTITY_TYPES.register("raptor_mech", () -> EntityType.Builder.of(RaptorMechEntity::new, MobCategory.CREATURE).sized(2.1F, 2.65F).clientTrackingRange(10).build("raptor_mech"));
