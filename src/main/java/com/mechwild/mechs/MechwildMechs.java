...
public class MechwildMechs {
    ...
    public static final RegistryObject<EntityType<RaptorMechEntity>> RAPTOR_MECH = ENTITY_TYPES.register("raptor_mech", () -> EntityType.Builder.of(RaptorMechEntity::new, MobCategory.CREATURE).sized(1.4F, 1.6F).clientTrackingRange(10).build("raptor_mech"));
